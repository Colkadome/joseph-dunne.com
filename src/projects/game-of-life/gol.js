...
function GOL(canvas) {
  ...
  var stepCode = this.fetch('gol.frag');
  ...
  this.setRandom(0.5);
  //this.loadImage('./mountains-1.png');
...
GOL.prototype.step = function() {
  ...
  gl.uniform2fv(textureSizeLocation, size);

  // Set 'a_position' attrib.

  var positionLocation = gl.getAttribLocation(program, 'a_position');

  gl.bindBuffer(gl.ARRAY_BUFFER, buffer);
  gl.enableVertexAttribArray(positionLocation);
  gl.vertexAttribPointer(positionLocation, 2, gl.BYTE, false, 0, 0);

  // Draw and swap back texture to front.
